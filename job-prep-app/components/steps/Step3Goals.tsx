...
const ROLES = [
  // IT/개발
  "프론트엔드 개발", "백엔드 개발", "풀스택 개발", "데이터 분석", "AI/ML 엔지니어",
  // 기획/비즈니스
  "기획/PM", "마케터", "디자이너", "영업/MD", "경영/전략", "회계/재무", "HR",
  // 공학/제조
  "연구개발(R&D)", "생산관리", "품질관리", "공정엔지니어", "기계/전기 엔지니어", "구매/SCM",
  "기타",
];
const INDUSTRIES = [
  // IT/서비스
  "IT/소프트웨어", "금융/핀테크", "게임", "커머스/유통", "미디어/콘텐츠",
  // 제조/중공업
  "반도체/전자", "자동차", "조선/해양", "항공우주/방산", "에너지/화학", "철강/소재",
  // 기타
  "바이오/헬스케어", "공공/공기업", "컨설팅", "기타",
];
